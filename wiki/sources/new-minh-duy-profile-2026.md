...
original_file: raw_sources/new-minh-duy-profile-2026.txt
---

## Summary
Minh Duy is a highly specialized AI professional and researcher, currently based in Ho Chi Minh City, Vietnam. His expertise lies in applying advanced Machine Learning and Deep Learning techniques to quantify operational risks posed by Unmanned Aerial Vehicles (UAVs) within the SORA (Specific Operations Risk Assessment) framework. Beyond his technical work, he is an entrepreneur, having founded Lowkie, a fitness-focused snack brand, and maintains a keen interest in the Vietnamese stock market.
...
- [GAS](wiki/entities/gas.md)
- [HPG](wiki/entities/hpg.md)
- [BWE](wiki/entities/bwe.md)
- [TDM](wiki/entities/tdm.md)

## Concepts Mentioned
- [Deep Learning](wiki/concepts/deep-learning.md)
- [Unmanned Aerial Vehicles (UAVs)](wiki/concepts/uavs.md)
- [SORA (Specific Operations Risk Assessment) framework](wiki/concepts/sora-framework.md)
