...
## Overview
Minh Duy, also known by the alias Rzy, is an AI Engineer and Research Engineer. He is highly specialized in applying Machine Learning and Deep Learning to quantify threats posed by Unmanned Aerial Vehicles (UAVs) within the SORA (Specific Operations Risk Assessment) framework. He is an active entrepreneur and professional who has relocated to Ho Chi Minh City, Vietnam.

## Key Facts
- **Aliases:** Rzy.
- **Current Location:** Ho Chi Minh City, Vietnam.
- **Education:** Master’s degree (graduated February 2026) from Soonchunhyang University.
- **Professional Focus:** AI/ML research, specifically threat quantification for UAVs.
- **Venture:** Founder of Lowkie, a fitness-focused snack brand.
- **Interests:** Fitness, monitoring the Vietnamese stock market.
