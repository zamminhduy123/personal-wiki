...
## Overview
Minh Duy, also known by the alias Rzy, is a highly specialized AI professional and researcher. He focuses on applying advanced Machine Learning and Deep Learning techniques to quantify operational risks posed by Unmanned Aerial Vehicles (UAVs) using the SORA framework. He is also an active entrepreneur, founding Lowkie, a fitness-focused snack brand.
