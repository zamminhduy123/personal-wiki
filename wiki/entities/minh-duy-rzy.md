...
## Overview
Minh Duy, also known by the alias Rzy, is a highly skilled AI Engineer and Research Engineer. He specializes in applying advanced Machine Learning and Deep Learning techniques to quantify threats posed by Unmanned Aerial Vehicles (UAVs). He is an active entrepreneur, having founded Lowkie, a fitness-focused snack brand. He is currently based in Ho Chi Minh City, Vietnam, and maintains a keen interest in the Vietnamese stock market and fitness.

## Key Facts
- **Aliases:** Rzy.
- **Current Location:** Ho Chi Minh City, Vietnam.
- **Education:** Master’s degree from Soonchunhyang University (graduated February 2026).
- **Professional Focus:** AI/ML research, specifically threat quantification for UAVs using SORA.
- **Venture:** Founder of Lowkie (fitness snack). 
- **Interests:** Fitness, monitoring Vietnamese stock market sectors (energy, utility, steel).
- **Career Status:** Actively seeking AI Scientist/Engineer roles (early 2026).
...
- [Profile of Minh Duy (Rzy), an AI Engineer specializing in UAV threat quantification and entrepreneurship.](wiki/sources/new-minh-duy-profile.md)
